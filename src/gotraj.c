...
#include "gotraj.h"		/* these decls */

#define reciprocate(x) (x) <= 0.0 ? GO_INF : 1.0 / (x)

/* constant acceleration functions */

go_result go_traj_ca_generate(go_real acc, go_real deltacc, go_real deltvel,
			      go_traj_ca_spec * pts)
{
  go_traj_ca_spec ts;
...
go_result go_traj_cj_generate(go_real jrk, go_real deltjrk, go_real deltacc,
...
*/
static go_result go_traj_cj_compute_the_rest(go_traj_cj_spec * pts)
{
...
/*!
  ...
  go_traj_cj_interp.
*/
static go_result go_traj_cj_compute_tees_na_nc(go_traj_cj_spec * pts)
{
...
/*!
  ...
  go_traj_cj_interp.
*/
static go_result go_traj_cj_compute_tees_a_nc(go_traj_cj_spec * pts)
{
  go_real a_j;
...
/*!
  ...
  go_traj_cj_interp.
*/
static go_result go_traj_cj_compute_tees_na_c(go_traj_cj_spec * pts)
{
...
/*!
  ...
  go_traj_cj_interp.
*/
static go_result go_traj_cj_compute_tees_a_c(go_traj_cj_spec * pts)
{
...
*/
go_result go_traj_cj_compute(go_real d, go_real v, go_real a, go_real j,
			     go_traj_cj_spec * pts)
{
  go_result retval;
