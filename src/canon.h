...
extern CANON_UNITS GET_EXTERNAL_LENGTH_UNIT_TYPE();
...
extern void SET_EXTERNAL_PARAMETER_FILE_NAME(const char *file_name);
...
extern int SET_EXTERNAL_TOOL_TABLE(int pocket, CANON_TOOL_TABLE tool);
